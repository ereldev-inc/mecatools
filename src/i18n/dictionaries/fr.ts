...
converters: "Convertisseurs",
  ...
  tools: {
    ...
    tireAge: {
      name: "Âge du pneu",
      title: "Âge du pneu : décoder le code DOT (semaine et année)",
      description:
        "Lisez le code DOT de votre pneu moto pour connaître sa semaine et son année de fabrication, son âge, et s'il faut le remplacer.",
      intro:
        "Saisissez le code DOT gravé sur le flanc (ou simplement ses derniers chiffres) pour obtenir la date de fabrication et l'âge du pneu.",
      about: [
        "Le code DOT est moulé sur le flanc du pneu. Ses quatre derniers chiffres donnent la date de fabrication : les deux premiers sont la semaine (01 à 53), les deux derniers l'année. Par exemple 2319 signifie semaine 23 de 2019. Les pneus fabriqués avant 2000 n'ont que trois chiffres.",
        "La gomme vieillit même quand le pneu ne roule pas. On surveille généralement le pneu de plus près après environ 5 ans et on le remplace au plus tard à 10 ans, quelle que soit l'usure. Suivez toujours les conseils du fabricant et vérifiez l'absence de craquelures, de durcissement et de déformations.",
      ],
    },
    valveClearance: {
  ...
  tire: {
    illustration: "Où trouver la semaine et l'année dans un code DOT",
    hint: "Repérez le code DOT sur le flanc. Seuls les 4 derniers chiffres comptent.",
    weekPart: "semaine",
    yearPart: "année",
    front: "Pneu avant",
    rear: "Pneu arrière",
    codeLabel: "Code DOT ou derniers chiffres",
    incomplete: "Saisissez les 4 derniers chiffres du code DOT (ex. 2319).",
    invalidWeek: "La semaine doit être comprise entre 01 et 53 : vérifiez le code.",
    future: "Cette date est dans le futur : vérifiez le code.",
    made: "Fabriqué semaine {week} de {year}",
    around: "Vers {date}",
    age: "Âge : {years} an(s) et {months} mois",
    good: "Moins de 5 ans : correct, continuez à surveiller son état.",
    check: "Entre 5 et 10 ans : inspectez-le soigneusement (craquelures, durcissement) et envisagez de le remplacer.",
    replace: "10 ans ou plus : remplacez-le, quelle que soit son usure.",
    tooOld: "Fabriqué avant 2000 : remplacez-le.",
  },
