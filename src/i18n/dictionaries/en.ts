...
converters: "Converters",
  ...
  tools: {
    ...
    tireAge: {
      name: "Tire age",
      title: "Tire age calculator: decode the DOT code (week and year)",
      description:
        "Read the DOT code on your motorcycle tire to find its week and year of manufacture, its age, and whether it should be replaced.",
      intro:
        "Type the DOT code printed on the sidewall (or just its last digits) to get the manufacturing date and age of the tire.",
      about: [
        "The DOT code is molded on the tire sidewall. Its last four digits give the manufacturing date: the first two are the week (01 to 53) and the last two the year. For example 2319 means week 23 of 2019. Tires made before 2000 only have three digits.",
        "Rubber ages even when the tire is not used. Tires are commonly inspected more closely after about 5 years and replaced at 10 years at the latest, regardless of wear. Always follow the advice of the tire manufacturer, and check for cracks, hardening and deformations.",
      ],
    },
    valveClearance: {
  ...
  tire: {
    illustration: "Where to find the week and year in a DOT code",
    hint: "Find the DOT code on the sidewall. Only the last 4 digits matter.",
    weekPart: "week",
    yearPart: "year",
    front: "Front tire",
    rear: "Rear tire",
    codeLabel: "DOT code or last digits",
    incomplete: "Enter the last 4 digits of the DOT code (e.g. 2319).",
    invalidWeek: "The week must be between 01 and 53: check the code.",
    future: "This date is in the future: check the code.",
    made: "Made in week {week} of {year}",
    around: "Around {date}",
    age: "Age: {years} year(s) and {months} month(s)",
    good: "Under 5 years: fine, keep checking its condition.",
    check: "Between 5 and 10 years: inspect it carefully (cracks, hardening) and consider replacing it.",
    replace: "10 years or more: replace it, whatever its wear.",
    tooOld: "Made before 2000: replace it.",
  },
